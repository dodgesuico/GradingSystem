    ...
    public function up(): void
    {
        if (!Schema::hasTable('users')) {
            ...
            DB::table('users')->insert([
                ['studentID' => '219286', 'name' => 'Dodge Nicholson P. Suico', 'gender' => 'male', 'email' => 'dodgesuico@ckcm.edu.ph', 'department' => 'College of Business Administration', 'password' => bcrypt('12345'), 'role' => 'student', 'created_at' => now(), 'updated_at' => now()],
                ...
                ['studentID' => '242424', 'name' => 'Marjon D. Ligan', 'gender' => 'male', 'email' => 'Ligan@ckcm.edu.ph', 'department' => 'College of Business Administration', 'password' => bcrypt('12345'), 'role' => 'instructor,dean', 'created_at' => now(), 'updated_at' => now()],
